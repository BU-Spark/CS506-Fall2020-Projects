...
# read data
district_vacant_housing = processData.import_csv('data\\district_housing_vacant.csv')
...
processData.write_csv('data\\district_housing_vacant.csv', X_district, header_district)
