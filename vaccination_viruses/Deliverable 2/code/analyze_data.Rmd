...
model3 <- lm(`2011` ~ spending_per_capita + population_density + Median_income + HighSchool_Plus + Bachelors_Plus + spending_per_pupil + Exemption, data=data)
...
```{r regression2}
model2 <- lm(`2011` ~ spending_per_capita + HighSchool_Plus + Exemption, data=data)
summary(model2)
...
glm.fit <- glm(`2011` ~ Exemption, data=data)
summary(glm.fit)
